...
search_directory = os.path.expanduser("/data/NOWCAST_IMD_RADAR/RADAR_DATA_FOLDERS/")
...
dir2 = os.path.expanduser("/data/NOWCAST_IMD_RADAR/PYSTEPS_DATA/PYSTEPS_INPUTS/")
...
dir3 = os.path.expanduser("/data/NOWCAST_IMD_RADAR/PYSTEPS_DATA/PYSTEPS_OUTPUT_DATA/")
