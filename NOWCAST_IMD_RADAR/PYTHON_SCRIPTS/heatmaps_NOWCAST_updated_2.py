...
def process_data(input_nc_variable, col, brk, sufix, img_extent, units, t, dpi, proj):
...
def heatmap(input_nc_variable, col, brk, sufix, img_extent, units):
    dpi = 700
    proj = ccrs.Mercator.GOOGLE
...
coll = ["#80aaff", "#003cb3", "#ff80b3", "#ff0066", "#cc0000", "#660000", "#ffcccc"]       
#brk=[0.1,0.5,1,2,3,5,10,15,20,25,1000] 
#brk = [0.5,2.5,5,10,20,30,40,50,75,100, 1000]
brkk = [0, 1, 4, 16, 30, 50, 100, 1000]
#heatmaps - dashboard
